...
* @see app/Http/Controllers/productsController.php:22
* @route '/product/store'
*/
...
/**
* @see \App\Http\Controllers\productsController::create
* @see app/Http/Controllers/productsController.php:17
...
/**
* @see \App\Http\Controllers\productsController::edit
* @see app/Http/Controllers/productsController.php:40
...
* @see app/Http/Controllers/productsController.php:50
* @route '/product/{product}'
*/
...
const productsController = { index, store, create, destroy, edit, update }
